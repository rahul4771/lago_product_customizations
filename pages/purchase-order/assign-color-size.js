...
const AssignColorSizeQuantity = (props) => {
    ...
    if (localStorage.getItem('customizationInfo')) {
        customizationInfo = JSON.parse(localStorage.getItem('customizationInfo'));
    }
    let preview_side = null;
    if(customizationInfo.customization_elements.front != undefined && customizationInfo.customization_elements.front != ''){
        preview_side = "front";
    } else if (customizationInfo.customization_elements.back != undefined && customizationInfo.customization_elements.back != ''){
        preview_side = "back";
    } else if(customizationInfo.customization_elements.sleeve != undefined && customizationInfo.customization_elements.sleeve != ''){
        preview_side = "sleeve";
    }
    ...
    const saveVariants = () => {
        ...
        if (flag == 0) {
            ...
            if (cartDetails == '' || cartDetails == null) {
                ...
                createDraftOrder(JSON.stringify(cart));
            } else {
    ...
    const createDraftOrder = async (cartDetails = null) => {
        ...
        if (cartDetails != null) {
            ...
            if (orderDetails && orderDetails.message == 'success') {
                ...
                setMessage("Purchase order " + orderName + " is created successfully");
                ...
                <div className="Polaris-Card__Section">
                    <div className="list--breabcrumbs">
                        <ul className="Polaris-List">
                            ...
                            <li className="Polaris-List__Item">
                                <Link href={{ pathname: "/", query: { tab: "create-PO", page: "assignArtwork", params: product.id } }}> Assign Artwork </Link>
                            </li>
                            <li className="Polaris-List__Item breadcrumbs--icon">
                                <img src={IconArrow} alt="Icon arrow right"/>
                            </li>
                            ...
                            <div className="display-text--title">
                                <div>
                                    <span className="Polaris-Tag color--purple">
                                        <span
                                            className="Polaris-Tag__TagText">{customer.name}</span>
                                    </span>
                                    <div id="PolarisPortalsContainer"></div>
                                </div>
                            </div>
                                ...
                                <div>
                                    <div className="Polaris-ButtonGroup">
                                        <div className="Polaris-ButtonGroup__Item">
                                            <Link href={{ pathname: "/", query: { tab: "create-PO", page: "assignArtwork", params: product.id } }}>
                                                        ...
                                                        <div className="Polaris-Layout__Section">
                                                            <div>
                                                                <span className="Polaris-Thumbnail Polaris-Thumbnail--sizeLarge">
                                                                    <img src={preview !== null && preview_side == "front" ? preview.front : preview_side == "back" ? preview.back : preview_side == "sleeve" ? preview.sleeve : product.image.src} alt="Image" />
                                                                </span>
                                                                <div id="PolarisPortalsContainer"></div>
                                                            </div>
                                                        </div>
                                                                                                                    ...
                                                                                                                    return Object.keys(option.values).map((index) => {
                                                                                                                        return variants.map((variant) => {
                                                                                                                            if (variant.option1 == option.values[index] && variant.option2 == value) {
                                                                                                                                uniqueKey2++;
                                                                                                                                return (
                                                                                                                                    <td key={variant.id+uniqueKey2} className="Polaris-DataTable__Cell Polaris-DataTable__Cell--verticalAlignTop">
                                                                                                                                                    ...
                                                                                                                                                    <div className="Polaris-TextField__Spinner"
                                                                                                                                                        ...
                                                                                                                                                        <div role="button"
                                                                                                                                                            ...
                                                                                                                                                            tabIndex="-1"  onClick={(e) => {
                                                                                                                                                                ...
                                                                                                                                                                if (document.getElementById(fieldID).value < 100000) {
...
export default AssignColorSizeQuantity;
