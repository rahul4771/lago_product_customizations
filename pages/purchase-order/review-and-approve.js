...
const ReviewAndApprove = (props) => {
	...
	const postCommendOnOrder = async () => {
		...
		let currentDateNew = newDate.toISOString().slice(0, 10);
			...
			<div className="Polaris-Card__Section">
				<div className="list--breabcrumbs">
					<ul className="Polaris-List">
						...
						<li className="Polaris-List__Item">
						<Link href={{ pathname: "/", query: { tab: "create-PO", page: "editColorSizeQuantity", params: JSON.stringify({"product": product, "orderId": orderId, "orderName": puchaseOrder.name, "lineItems" : variants}) } }}> Assign Color, Size, Quantity </Link>
						</li>
						<li className="Polaris-List__Item breadcrumbs--icon">
							<img src={IconArrow} alt="Icon arrow right"/>
						</li>
												...
												<div>
																	...
																	<div className="Polaris-Layout assign_artwork--assign" style={{ borderBottom: "1px solid #d2d2d5" }}>
																		...
																		<div className="Polaris-Layout__Section">
																			<div>
																				...
																				<div className="Polaris-Card__Section">
																					<div>
																						<button type="button" className="Polaris-Tag Polaris-Tag--clickable color--blue Margin-left-5">
																							Garments Selected
																						</button>
																						<button type="button" className="Polaris-Tag Polaris-Tag--clickable color--purple Margin-left-5">
																							Artwork Assigned
																						</button>
																						<button type="button" className="Polaris-Tag Polaris-Tag--clickable color--cyan Margin-left-5">
																								...
																								<div>
																									<div>
																										...
																										<div className="Polaris-DataTable">
																												...
																												<table className="Polaris-DataTable__Table">
																													...
																													<tbody>
																														{placedArtwork.map((placedArt, index) => {
																															uniqueId++;
																															return (
																																<Fragment key={"artwork" + placedArt.id+uniqueId}>
																											...
																											<a href={PREVIEW_URL + "/pages/all-preview?orderId=" + orderId + "&productId=" + key + "&token=" + TOKEN}  target="_blank">View All</a>
																										</div>
																									</div>
																								</div>
																							</div>
													...
													<div>
														<div className="Polaris-ButtonGroup Align-center">
															...
															<div className="Polaris-ButtonGroup__Item">
																<Link href={{ pathname: '/', query: { tab: 'create-PO', page: 'reviewAndComplete', params: JSON.stringify({ orderId: orderId, product: product, approveFlow: true }) } }}>
																	<button className="Polaris-Button Polaris-Button--primary" type="button">
																		<span className="Polaris-Button__Content">
